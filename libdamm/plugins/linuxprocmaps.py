...
def getFields():
    ...
    '''
    return LinuxProcmaps().get_field_keys()


class LinuxProcmapsSet(memobj.MemObjectSet):
    '''
...
class LinuxProcmaps(memobj.MemObject):
