...
def getPluginObject(vol):
    ...
    '''
    return LinuxUnifiedthreadsSet(vol)
...
def getFields():
    ...
    '''
    return LinuxUnifiedthreads().get_field_keys()


class LinuxUnifiedthreadsSet(memobj.MemObjectSet):
    '''
...
class LinuxUnifiedthreads(memobj.MemObject):
